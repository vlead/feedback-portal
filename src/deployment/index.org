...
def populate():
    ...
    question1 = question_cls(name="Did you do the experiment?", 
    ...
    question6 = question_cls(name="Does this help you to perform better in the curriculum?", 
                             question_type=q_type)

    question7 = question_cls(name="If you had to do this experiment physically do you think this experiment prepares to do it better physically?", 
                             question_type=q_type)

    question8 = question_cls(name="Would you recommend it to your fellow students?", 
                             question_type=q_type)
    
    q_type = "text"
    question9 = question_cls(name="Additional Comments", 
                             question_type=q_type)
