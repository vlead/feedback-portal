...
def populate():
    ...
    question3 = question_cls(name="3. Did you find any bugs in the experiment?", 
                             question_type=q_type)

    question4 = question_cls(name="4. How much did you know about the experiment before doing it in Virtual Labs?", 
                             question_type=q_type)

    question5 = question_cls(name="5. Is this experiment part of your curriculum?", 
                             question_type=q_type)

    question6 = question_cls(name="6. Does this help you to perform better in the curriculum?", 
                             question_type=q_type)

    question7 = question_cls(name="7. If you had to do this experiment physically do you think this experiment prepares to do it better physically?", 
                             question_type=q_type)

    question8 = question_cls(name="8. Would you recommend it to your fellow students?", 
                             question_type=q_type)
    
    q_type = "text"
    question9 = question_cls(name="9. Additional Comments", 
                             question_type=q_type)
