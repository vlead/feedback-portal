...
def populate():
    ...
    question6 = question_cls(name="5. Does this help you to perform better in the curriculum?",
                             question_type=q_type)

    question7 = question_cls(name="6. Would you recommend it to your fellow students?",
                             question_type=q_type)

    q_type = "text"
    question8 = question_cls(name="Comments",
                             question_type=q_type)
