...
#+NAME: persistent_response_exists
#+BEGIN_SRC python
    def response_exists(self, new_response):
        question = new_response.get("question")
        answers = new_response.get("answers")
        n_responses = self.get_responses(question=question)
        if n_responses:
            response = filter(lambda x: x.get("answers") == answers,
                                  n_responses)
            if response:
                return True
            else:
...
**** Tests
#+NAME: test_persistent_response_exists
#+BEGIN_SRC python
    def test_response_exists(self):
        ...
        name1 = "how are labs?"
        q_type1 = "radio"
        question1 = Question(name=name1, question_type=q_type1)
        question1.save()

        name2 = "how are experiments?"
        q_type2 = "radio"
        question2 = Question(name=name2, question_type=q_type2)
        question2.save()
        ...
        res1 = Response(question=question1, answers=[answer1], feedbacks=[fb1])
        res1.save()

        res2 = Response(question=question2, answers=[answer2], feedbacks=[fb1])

        self.assertEqual(self.persistent_delegate.response_exists(res1),
                            True)
        self.assertEqual(self.persistent_delegate.response_exists(res2),
                            False)
...
#+NAME: persistent_feedback_exists
#+BEGIN_SRC python
    def feedback_exists(self, fb_id):
        try:
            feedback = Feedback.get_by_id(fb_id)
            return True
...
**** Tests
#+NAME: test_persistent_feedback_exists
#+BEGIN_SRC python
    def test_feedback_exists(self):
        ...
        self.assertEqual(self.persistent_delegate.feedback_exists(1),
                            True)
        self.assertEqual(self.persistent_delegate.feedback_exists(2),
                            False)
...
#+BEGIN_SRC python
    def add_feedback(self, gateway_ip, lab_name, exp_name, date, responses):
...
#+NAME: persistent_get_feedback_usage
#+BEGIN_SRC python
...
**** Tests
#+NAME: test_persistent_get_feedback_usage
#+BEGIN_SRC python
    def test_get_feedback_usage(self):
         ...
         date1 = datetime.datetime.strptime("30-06-2016", "%d-%m-%Y").date()
         responses1 = []
         fb1 = self.persistent_delegate.add_feedback(gateway_ip1, lab_name1,
                                                        exp_name1, date1,
                                                        responses1)
         ...
         responses2 = []
         fb2 = self.persistent_delegate.add_feedback(gateway_ip2, lab_name2,
                                                        exp_name2, date2,
                                                        responses2)
         usage = self.persistent_delegate.get_feedback_usage(gateway_ip2, 
                                                                 date2)
...
***  Get feedback Dump from the system
    This function gets the feedback usage from the system.
#+NAME: persistent_get_feedback_dump
#+BEGIN_SRC python
...
**** Tests
#+NAME: test_persistent_get_feedback_dump
#+BEGIN_SRC python
    def test_get_feedback_dump(self):
         ...
         fb2 = self.persistent_delegate.add_feedback(gateway_ip2, lab_name2,
                                                        exp_name2, date2,
                                                        responses2)
         feedbacks = self.persistent_delegate.get_feedback_dump(date2)
...
***  Add response to the system
    This function adds responses to the system.
#+NAME: persistent_add_responses_to_feedback
#+BEGIN_SRC python
    def add_responses_to_feedback(self, fb_id, new_responses):
        feedback = Feedback.get_by_id(fb_id)
...
**** Tests
#+NAME: test_persistent_add_responses_to_feedback
#+BEGIN_SRC python
    def test_add_responses_to_feedback(self):
         print "test_add_responses_to_feedback"
         ...
         feedback = self.persistent_delegate.add_responses_to_feedback(1,
                                                                        [res])
...
***  Get Responses
    This function returns responses if present in the database.  If the response is
    not present, =None= type is returned.
#+NAME: persistent_get_responses
#+BEGIN_SRC python
    def get_responses(self, **kwargs):
        ret_val = None
        try:
            ret_val = Response.apply_filters(**kwargs)
        except NotFoundError as e:
            ret_val = None
...
****  Tests
#+NAME: test_persistent_get_responses
#+BEGIN_SRC python
    def test_get_responses(self):
         ...
         response_obj = self.persistent_delegate.get_responses(\
                                                            question=question)
         self.assertEqual(response_obj[0].get("question").get("name"),
                              res.get("question").get("name"))
         self.assertEqual(response_obj[0].get("answers")[0].get("name"),
...
****  Tests
#+NAME: test_persistent_get_feedback
#+BEGIN_SRC python
    def test_get_feedbacks(self):
         print "test_get_feedbacks"
         ...
         feedback_obj = self.persistent_delegate.get_feedbacks(gateway_ip=\
...
<<persistent_get_responses>>
<<persistent_question_exists>>
<<persistent_answer_exists>>
<<persistent_feedback_exists>>
<<persistent_response_exists>>
<<persistent_add_question>>
<<persistent_add_answer>>
<<persistent_add_feedback>>
<<persistent_get_feedbacks>>
<<persistent_get_feedback_usage>>
<<persistent_get_feedback_dump>>
<<persistent_add_responses_to_feedback>>
...
<<test_persistent_get_responses>>
<<test_persistent_question_exists>>
<<test_persistent_answer_exists>>
<<test_persistent_feedback_exists>>
<<test_persistent_response_exists>>
<<test_persistent_add_question>>
<<test_persistent_add_answer>>
<<test_persistent_add_feedback>>
<<test_persistent_get_feedback>>
<<test_persistent_get_feedback_usage>>
<<test_persistent_get_feedback_dump>>
<<test_persistent_add_responses_to_feedback>>
<<run_test_cases>>
