...
#+BEGIN_SRC python
    def response_exists(self, new_response):
        ...
        return new_response == self.get_response(question=question, \
                                                     answers=answers)
...
#+BEGIN_SRC python
    def test_response_exists(self):
        ...
        self.assertEqual(self.persistent_delegate.response_exists(res1),
                            True)
        self.assertEqual(self.persistent_delegate.answer_exists(res2),
                            False)
...
***  Get Response
    ...
    not present, =None= type is returned.
#+NAME: persistent_get_response
#+BEGIN_SRC python
    def get_response(self, **kwargs):
        return self.get_object(Response, **kwargs)

#+END_SRC

****  Tests
#+NAME: test_persistent_get_response
#+BEGIN_SRC python
    def test_get_response(self):
         ...
         response_obj = self.persistent_delegate.get_response(\
                                                            question=question)
