...
** Add Question
   REST API to get and post question
...
function renderFeedbackform() {
	...
	if (feedbackForm.questions[i].type === "checkbox") {
	    ...
	    if(i == 4 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_experiment" || i == 1 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_lab"){
	      //  renderQuesLabel();
	    ...
	    else if(i == 7 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_experiment" || i == 5 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_lab"){
...
//	      break;
    ...
    if(count == 0){
	if(feedbackForm.version == "generic-feedback-v2.0"){
