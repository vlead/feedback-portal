...
#+BEGIN_SRC javascript :tangle ./static/js/main.js :eval no :noweb yes
  ...
  function renderFeedbackform() {
      ...
      for (var i = 0; i < quesArray; i++) {
          if (feedbackForm.questions[i].type === "checkbox") {
              ...
              optionsDiv1.id = feedbackForm.questions[i].name;
              var optionsLength = feedbackForm.questions[i].options.length;
	      ...
	      if(i == 2 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_experiment" || i == 0 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_lab"){
		//  renderQuesLabel();
		  console.log(i);
	      ...
	      else if(i == 4 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_experiment" || i == 2 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_lab"){
		  console.log(i);
		//  renderQuesLabel();
		  labelQues = document.createElement('div');
	      ...
	      else if(i == 5 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_experiment" || i == 3 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_lab"){
		  console.log(i);
		//  renderQuesLabel();
		  labelQues = document.createElement('div');
		  ...
		  GenerateTable("Not at all", "May Recommend", "Will definitely","dvTable2");
              ...
              ansTextArea.id = feedbackForm.questions[i].name;
  ...
  function submitFeedback(event) {
      ...
      for (var i = 0; i < quesArray; i++) {
          var questionElement = document.getElementById(feedbackForm.questions[i].name);
          var answer = null;
      ...
      else{alert("Please do fill the total feedback");}
