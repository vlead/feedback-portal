...
def get_redirect():
    return redirect('https://open-edx.vlabs.ac.in')
...
#+BEGIN_SRC javascript :tangle ./static/js/main.js :eval no :noweb yes
  ...
  function renderFeedbackform() {
	  ...
	  {
	      var elem = document.getElementById("exp_name_value");
      ...
      for (var i = 0; i < quesArray; i++) {
		  ...
		  labelQues2.innerHTML = "&nbsp;<font color='#800000'>*</font>";
	      }
	      ...
	      if(i == 3 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_experiment" || i == 0 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_lab"){
		//  renderQuesLabel();
	      ...
	      else if(i == 5 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_experiment" || i == 2 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_lab"){

		//renderQuesLabel();
		  labelQues = document.createElement('div');
		  labelQues.id="dvTable1";
		  formGroup.appendChild(labelQues);
		  GenerateTable("Not at all", "To some extent", "Much better","dvTable1");
	      }

	      else if(i == 6 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_experiment" || i == 3 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_lab"){
		...
		//  renderQuesLabel();
		  ...
		  if(flag == "No"){
		      var element = document.getElementById("bug-answer");
		      element.outerHTML = "";
		      delete element;
		  }
		  else{
  ...
  function submitFeedback(event) {
      ...
      var count=0;
      for(var i=0;i<feedback.responses.length-1;i++){
	  if(feedback.responses[i].answers!= ""){
	      count=count+1;
	      //console.log(feedback.responses[i]);
	      }
      }
      if(count == feedback.responses.length-1){
	  add_feedback();
      }
      else{alert("Some of the questions are not answered");}
