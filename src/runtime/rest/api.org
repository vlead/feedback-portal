...
function renderFeedbackform() {
	...
	if (feedbackForm.questions[i].type === "checkbox") {
	    ...
	    else if(i == 6 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_experiment" || i == 4 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_lab"){
...
function submitFeedback(event) {
	...
	if(feedbackForm.questions[i].mandatory == "Yes" && feedback.responses[i].answers.length  == 0){
...
//	      break;
	...
	alert(not_answered + " Questions are not answered");
    }
