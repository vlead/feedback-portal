...
#+BEGIN_SRC python
@api.route('/questions/<id>', methods=['PUT', 'DELETE'])
def update_and_delete_question(id):
    ...
    if request.method == 'DELETE':
        if request.is_json:
            data_json = json.dumps(request.get_json())
            data_dict = yaml.safe_load(data_json)
            data_dict['q_id']=int(id)
        else:
            abort(500, "the request does not contain data in json")

        try:
            q1 = SystemInterface.delete_question(data_dict)
            return jsonify('{"status":"sucess"}')
...
function renderFeedbackform() {
	...
	if (feedbackForm.questions[i].type === "checkbox") {
	    ...
	    if(i == 4 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_experiment" || i == 1 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_lab" || i == 2 && feedbackForm.version == "generic-lab-feedback-v2.0" || i == 6 && feedbackForm.version == "generic-exp-feedback-v2.0"){
	      //  renderQuesLabel();
	    ...
	    else if(i == 6 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_experiment" || i == 4 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_lab" ||i == 5 && feedbackForm.version == "generic-lab-feedback-v2.0"|| i == 8 && feedbackForm.version == "generic-exp-feedback-v2.0"){
	    ...
	    else if(i == 7 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_experiment" || i == 5 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_lab"||i == 6 && feedbackForm.version == "generic-lab-feedback-v2.0"|| i == 9 && feedbackForm.version == "generic-exp-feedback-v2.0"){
		...
		if(i == 0 && k == 0 && (feedbackForm.version == "generic-feedback-v2.0" || feedbackForm.version == "open-edx-virtual-labs-v2.0_for_experiment" || feedbackForm.version == "open-edx-virtual-labs-v2.0_for_lab")){
		    radioOption.checked = true;
		}
		if(i == 2 && k == 0 && (feedbackForm.version == "generic-exp-feedback-v2.0")){
		    radioOption.checked = true;
		}
		if(i == 1 && k == 0 && (feedbackForm.version == "generic-lab-feedback-v2.0")){
		    radioOption.checked = true;
		}
		if(i == 1 && k == 0 && feedbackForm.questions[i].driver.length!=0 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_experiment"){
		    var questions = feedbackForm.questions[i].driver;
		    radioOption.onclick = function(){driver(questions, 'Not applicable', 'false'); };
		}
		if(i == 1 && k == 1  && feedbackForm.questions[i].driver.length!=0 && feedbackForm.version == "open-edx-virtual-labs-v2.0_for_experiment"){
		    var questions = feedbackForm.questions[i].driver;
		    radioOption.onclick = function(){ driver(questions, 'Not applicable', 'true'); };
		}
		if(i == 3 && k == 0 && feedbackForm.version == "generic-exp-feedback-v2.0" && feedbackForm.questions[i].driver.length!=0){
		    var questions = feedbackForm.questions[i].driver;
		    radioOption.onclick = function(){driver(questions, 'Not applicable', 'false'); };
		}
		if(i == 3 && k == 1  && feedbackForm.version == "generic-exp-feedback-v2.0" &&  feedbackForm.questions[i].driver.length!=0){
		    var questions = feedbackForm.questions[i].driver;
		    radioOption.onclick = function(){ driver(questions, 'Not applicable', 'true'); };
		}
...
//	      break;
    ...
    if(count == 0){
	if(feedbackForm.version == "generic-feedback-v2.0" || feedbackForm.version == "generic-lab-feedback-v2.0" || feedbackForm.version == "generic-exp-feedback-v2.0"){
