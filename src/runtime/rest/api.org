...
#        print "data json = %s" % data_json
#        print "data dict = %s" % data_dict
#        print "type of data dict = %s" % type(data_dict)
...
#            print lab_name, key, responses
        ...
        if 'gateway_ip' not in data_dict:
 ...
 #       print exp_name, gateway_ip, date
        current_app.logger.debug("exp_name = %s, gateway_ip=%s, date=%s, "
                                     %(exp_name, gateway_ip, date))
        try:
