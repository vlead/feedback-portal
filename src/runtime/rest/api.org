...
#+BEGIN_SRC html :tangle ./templates/index.html :eval no :noweb yes
  ...
  <html>
	...
	<br><p>
      ...
      <iframe height="390" width="100%" frameborder="0" id="footerIframe" >
...
*** footer-js
   This function set the footer service with in the footer iframe. We
   give =http://footer.vlabs.ac.in/footer= as source of the
   iframe. The content of the footer will be dynamically served from
   the footer service.
