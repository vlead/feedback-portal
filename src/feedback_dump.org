...
** Implementation of methods
   This code computes the date of previous day (server time) and make then invoke http request
   to =feedback= service for given day to get the feedback dump and pushes them to =elasticsearch= service
